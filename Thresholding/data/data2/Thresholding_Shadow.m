...
%input image
Orimage1 = imread([DIR,'','shadow1.jpg']);
Orimage2 = imread([DIR,'','shadow2.jpg']);
...
DIR_OUTPUT1 =[DIR,'','sauvolaThres3.jpg'];
DIR_OUTPUT2 =[DIR,'','sauvolaThres4.jpg'];
DIR_OUTPUT3 =[DIR,'','otsuThres3.jpg'];
DIR_OUTPUT4 =[DIR,'','otsuThres4.jpg'];
DIR_OUTPUT5 =[DIR,'','nickThres3.jpg'];
DIR_OUTPUT6 =[DIR,'','nickThres4.jpg'];
DIR_OUTPUT7 =[DIR,'','niblackThres3.jpg'];
DIR_OUTPUT8 =[DIR,'','niblackThres4.jpg'];
