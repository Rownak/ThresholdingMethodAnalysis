DIR = 'G:\Image Processing\Starting\Thresholding\data\data3\';
%input image
Orimage1 = imread([DIR,'','shadow_illum1.jpg']);
Orimage2 = imread([DIR,'','shadow_illum2.jpg']);
...
DIR_OUTPUT1 =[DIR,'','sauvolaThres5.jpg'];
DIR_OUTPUT2 =[DIR,'','sauvolaThres6.jpg'];
DIR_OUTPUT3 =[DIR,'','otsuThres5.jpg'];
DIR_OUTPUT4 =[DIR,'','otsuThres6.jpg'];
DIR_OUTPUT5 =[DIR,'','nickThres5.jpg'];
DIR_OUTPUT6 =[DIR,'','nickThres6.jpg'];
DIR_OUTPUT7 =[DIR,'','niblackThres5.jpg'];
DIR_OUTPUT8 =[DIR,'','niblackThres6.jpg'];
