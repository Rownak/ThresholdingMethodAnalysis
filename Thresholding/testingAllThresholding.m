DIR = 'G:\Image Processing\Starting\Thresholding\data\data7\';
%input image
Orimage1 = imread([DIR,'','blurred1.jpg']);
Orimage2 = imread([DIR,'','blurred2.jpg']);
...
DIR_OUTPUT1 =[DIR,'','sauvolablurred1.jpg'];
DIR_OUTPUT2 =[DIR,'','sauvolablurred2.jpg'];
DIR_OUTPUT3 =[DIR,'','otsublurred1.jpg'];
DIR_OUTPUT4 =[DIR,'','otsublurred2.jpg'];
DIR_OUTPUT5 =[DIR,'','nickblurred1.jpg'];
DIR_OUTPUT6 =[DIR,'','nickblurred2.jpg'];
DIR_OUTPUT7 =[DIR,'','niblackblurred1.jpg'];
DIR_OUTPUT8 =[DIR,'','niblackblurred2.jpg'];
DIR_OUTPUT9 =[DIR,'','bradleyblurred1.jpg'];
DIR_OUTPUT10 =[DIR,'','bradleyblurred2.jpg'];
